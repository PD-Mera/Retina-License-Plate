...
parser.add_argument('--training_dataset', default='./data/licenseplate/train/label.txt', help='Training dataset directory')
...
def train():
    ...
    dataset = LicensePlateDetection( training_dataset,preproc(img_dim, rgb_mean))
